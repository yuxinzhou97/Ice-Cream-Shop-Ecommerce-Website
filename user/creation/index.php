...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO user_information (FirstName, LastName, Email, HomeAddress, HomePhone, CellPhone, Password) VALUES ('".$_POST["FirstName"]."', '".$_POST["LastName"]."', '".$_POST["Email"]."','".$_POST["HomeAddress"]."','".$_POST["HomePhone"]."','".$_POST["CellPhone"]."','".$_POST["Password"]."')";    
